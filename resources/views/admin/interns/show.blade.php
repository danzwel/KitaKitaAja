    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
        <div class="space-y-6 lg:col-span-2">
            ...
            <x-admin.card title="Surat Balasan" subtitle="Dapat diunduh mahasiswa melalui dashboard mereka">
                ...
                <form method="POST" action="{{ route('admin.reply-letters.store', $intern) }}" enctype="multipart/form-data" class="flex items-center gap-3">
                    @csrf
                    <input type="file" name="file" accept="application/pdf" required
                           class="flex-1 rounded-lg border border-[#E3E5DE] px-3 py-2 text-sm file:mr-3 file:rounded-md file:border-0 file:bg-[#E7F2ED] file:px-3 file:py-1.5 file:text-xs file:font-medium file:text-[#0B5443]">
